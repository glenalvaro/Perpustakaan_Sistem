<div class="page-inner pd-0-force">
      <div class="wrapper">
          <div class="row clearfix mg-x-5-force mg-t-20 tx-rubik">
               <div class="col">
                 <form action="<?= base_url('buku/tambah_buku') ?>" method="post" autocomplete="off" enctype="multipart/form-data">
                   <div class="card mg-b-30">
                          <div class="card-header d-flex align-items-center justify-content-between">
                              <h6 class="tx-14 mg-b-0">Tambah Data Buku Perpustakaan</h6>
                          </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-8">
                                <div class="card mg-b-30">
                                  ...
                                  <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="kode_isbn" id="isbn-input" class="form-control" value="<?= set_value('kode_isbn') ?>">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <input type="text" name="judul_buku" class="form-control" placeholder="Enter..." value="<?= set_value('judul_buku') ?>">
                                        <ul class="parsley-errors-list filled">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                           <input type="text" name="pengarang" id="pengarang_nama" class="form-control" value="<?= set_value('pengarang') ?>" readonly>
                                        ...
                                        <label>Kategori Buku</label>
                                         <select name="kategori" class="selectpicker form-control" data-style="btn-default" data-live-search="true">
                                            ...
                                            <?php foreach($get_kategori as $gk) : ?>
                                                <option value="<?= $gk['kode_kategori']; ?>"><?= $gk['kode_kategori']; ?>--<?= $gk['nama_kategori']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                         <ul class="parsley-errors-list filled">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                           <input type="text" name="penerbit" id="penerbit_nama" class="form-control" value="<?= set_value('penerbit') ?>" readonly>
                                           <div class="input-group-append">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="jumlah_halaman" class="form-control" placeholder="Enter..." value="<?= set_value('jumlah_halaman') ?>">
                                         <ul class="parsley-errors-list filled">
                                    ...
                                    <div class="form-group">
                                        <label>Keterangan Buku</label>
                                         <select name="keterangan" class="form-control select2">
                                          <option value="<?= set_value('keterangan') ?>"><?= set_value('keterangan') ?></option>
                                  ...
                                  <div class="card-body">
                                    ...
                                    <hr>
                                     <div class="row justify-content-center">
                                      <img src="<?= base_url() ?>assets/images/cover/default_cover.jpg" class="img-thumbnail img-preview" width="150" height="150">
                                   </div>
...
<div class="modal fade" id="Mpengarang" data-backdrop="static">
...
<div class="modal" id="input-pengarang" data-backdrop="static">
...
<div class="modal fade" id="Mpenerbit" data-backdrop="static">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content tx-rubik">
      <div class="modal-header">
...
<div class="modal" id="input-penerbit" data-backdrop="static">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content tx-rubik">
      <div class="modal-header">

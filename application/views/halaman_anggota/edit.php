...
<div class="page-inner pd-0-force">
   <div class="row clearfix mg-x-5-force mg-t-20 tx-rubik">
      <div class="col">
         <form method="POST" action="<?= base_url('anggota/edit_anggota/'); ?><?= $anggota['id']; ?>" enctype="multipart/form-data">
          <div class="card mg-b-20">
               <div class="card-header d-flex align-items-center justify-content-between">
                  <h6 class="tx-14 mg-b-0 ml-2">Edit Anggota Perpustakaan</h6>
               </div>
               <div class="card-body">
               	<div class="row">
               	<div class="col-md-8">
                            ...
                            <div class="form-row">
                              <div class="col-md-12 mb-3">
                                 <label for="">Nama Lengkap</label>
                                  ...
                                  <input type="hidden" name="id_akses" class="form-control" value="<?= $anggota['id_akses']; ?>">
                              ...
                              <div class="col-md-12 mb-3">
                               ...
                               <div class="col-md-6 mb-3">
                                 ...
                                 <input type="text" id="dtp-date" name="tgl_lahir" class="form-control" value="<?= $anggota['tgl_lahir']; ?>">
                                 <ul class="parsley-errors-list filled">
                               ...
                               <div class="col-md-6 mb-3">
                                 <label for="">Jurusan</label>
                                  ...
                                  <select name="jurusan" class="selectpicker form-control" data-style="btn-default" data-live-search="true">
                                    ...
                                    <option value="Kreatif Kriya Kayu & Rotan">Kreatif Kriya Kayu dan Rotan (KKKR)</option>
                                    <option value="Desain komunikasi Visual">Desain Komunikasi Visual (DKV)</option>
                                 </select>
                              </div>
                              <div class="col-md-12 mb-3">
                                 <label for="">Phone</label>
                                 <input type="text" name="no_hp" class="form-control" id="phone-input" value="<?= $anggota['no_hp']; ?>">
                                 <ul class="parsley-errors-list filled">
                             ...
                             <!--  <div class="col mb-3">
                                 ...
                                 <select name="id_akses" class="selectpicker form-control" data-style="btn-default" data-live-search="true">
                                    <option value="<?= $anggota['id_akses']; ?>">
                                      <?php 
                                         if($anggota['id_akses'] == 1 ){
                                           echo "Administrator";
                                         } else if($anggota['id_akses'] == 2) {
                                           echo "Siswa";
                                         } else{
                                           echo "Kepala Sekolah";
                                         }
                     ...
                     <div class="card mg-b-30">
                        ...
                        <div class="card-body">
                        	<div class="row justify-content-center">
                        		<img src="<?= base_url('assets/images/profil/') . $anggota['foto']; ?>" class="img-thumbnail img-preview" width="150" height="150">
                        	</div>
                        ...
                        <div class="card-body">
                           <div class="row">
                              <div class="col-md-12 mg-b-20">
                                 ...
                                 <input type="text" class="form-control" value="<?= $anggota['nisn']; ?>" readonly>
                              </div>
                              <div class="col-md-12 mb-3">
                                 <label for="">Tanggal Terdaftar</label>
                                 <input type="text" class="form-control" value="<?= date('d F Y', $anggota['tgl_terdaftar']); ?>" readonly>
                              </div>
                           </div> 
                        </div>
                     </div>
               ...
               <button type="submit" class="btn btn-outline-info">Update Data</button>
       			<a href="<?= base_url('anggota') ?>"><button type="button" class="btn btn-outline-info">Kembali</button></a>
       		</div>
          </div>
       </form>
       </div>

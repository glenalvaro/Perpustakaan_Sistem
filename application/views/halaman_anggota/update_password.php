<div class="page-inner pd-0-force">
   <div class="row clearfix mg-x-5-force mg-t-20 tx-rubik">
      <div class="col">
         <form method="POST" action="<?= base_url('anggota/update_password/'); ?><?= $Data['id']; ?>" enctype="multipart/form-data">
           <div class="card mg-b-30">
               <div class="card-header d-flex align-items-center justify-content-between">
                  <h6 class="tx-14 mg-b-0 ml-2">Update Password Siswa -- <?= $Data['nama'] ?></h6>
               </div>
               <div class="card-body">
               	<div class="row">

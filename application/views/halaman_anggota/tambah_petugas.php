<div class="page-inner pd-0-force">
   <div class="row clearfix mg-x-5-force mg-t-20 tx-rubik">
      <form action="<?= base_url('petugas/tambah_petugas') ?>" method="post" autocomplete="off" enctype="multipart/form-data">
      <div class="col-lg-12">
         <div class="card mg-b-20">
            <div class="card-header d-flex align-items-center justify-content-between">
                  <h6 class="tx-14 mg-b-0 ml-2">Foto Petugas</h6>
            </div>
            <div class="card-body">
      ...
      <div class="col-lg-12">
          <div class="card mg-b-20">
               <div class="card-header d-flex align-items-center justify-content-between">
                  <h6 class="tx-14 mg-b-0 ml-2">Tambah Petugas Perpustakaan</h6>
               </div>
               <div class="card-body">
                     <div class="form-row mg-x-10-force">
                        <h5 class="card-text tx-14 mg-l-5 mb-3">Data Personal Petugas</h5>
                         <div class="col-md-12 mb-3">
                           <label for="">NIP</label>
                           <input type="number" name="nisn" id="nisn" class="form-control" value="<?= set_value('nisn') ?>">
                            <p style="color: #8dabc4; font-size: 11px; margin-left: 5px; font-style: italic;">* Untuk username petugas adalah nip</p>
                        ...
                        <div class="col-md-12 mb-3">
                           ...
                           <input type="number" name="no_hp" id="no_hp" class="form-control" value="<?= set_value('no_hp') ?>">
                           <ul class="parsley-errors-list filled">
                        ...
                        <div class="col-md-12 mb-3">
                           ...
                           <select name="id_akses" class="selectpicker form-control" data-style="btn-default" data-live-search="true">
                               <option value="<?= set_value('id_akses') ?>"><?= set_value('id_akses') ?></option>
                              <option value="1">1. Administrator</option>
                              <option value="3">2. Kepala Sekolah</option>
                           </select>
                            <ul class="parsley-errors-list filled">
                              <li class="parsley-required mg-l-5 mg-t-3"> <?= form_error('id_akses'); ?></li>
                           </ul>
                        </div>

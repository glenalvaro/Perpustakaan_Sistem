   ...
   <div class="row clearfix mg-x-5-force mg-t-20 tx-rubik">
    ...
    <div class="col">
       ...
       <div class="card-body tx-rubik">
              <h5 style="color: #4f8fda;" class="tx-15 mb-4">Kategori Buku <?= $detail['nama_kategori']; ?></h5>
         <div class="row clearfix">
               <?php foreach($kategori_list as $value) : ?>
                     <div class="w-100 p-2">
                        <div class="thumbnail-phone">
                        <div class="thumbnail-image-phone">
                           <img src="<?= base_url('assets/images/cover/') . $value->cover_buku; ?>" alt="<?= $value->judul_buku; ?>">
                        </div>
                        <div class="thumbnail-content-phone">
                           <a href="<?=site_url('transaksi/detail_peminjaman/'.$value->id)?>"><div class="thumbnail-title-phone"><?= $value->judul_buku; ?></div></a>
                           <div class="thumbnail-ket"><p class="tx-12" style="margin-top: 10px;">ISBN : <?= $value->kode_isbn; ?></p></div>
                           <div class="thumbnail-ket"><p class="tx-12">Keterangan : <?= $value->keterangan; ?></p></div>
                        </div>
                     </div>
                  </div>
               <?php endforeach; ?>
